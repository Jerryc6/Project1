                ...
                foreach ($query_run as $bed) {
                    ?>
                        ...
                        <td><?php echo $bed['id'];?></td>
                          ...
                          <td><?php echo $bed['room_number'];?></td>
                          <td><?php echo $bed['monthly_rent'];?></td>
                          <td><?php echo $bed['sta_tus'];?></td>
                          <td><img src="file/<?php echo $bed['image'];?>" width="300" title="<?php echo $bed['image'];?>"> </td>
                        </tr>
                    <?Php
                }
               }
