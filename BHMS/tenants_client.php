                ...
                foreach ($query_run as $bed) {
                    ?>
                        ...
                        <td><?php echo $bed['id'];?></td>
                          <td><img src="file/<?php echo $bed['profile'];?>" width="100" title="<?php echo $bed['profile'];?>"> </td>
                          <td><?php echo $bed['fullname'];?></td>
                          <td><?php echo $bed['contact'];?></td>
                          <td><?php echo $bed['address'];?></td>
                        </tr>
                    <?Php
                }
               }
